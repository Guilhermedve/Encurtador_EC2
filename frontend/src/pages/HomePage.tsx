...
export function HomePage() {
  return (
    <div className="relative min-h-screen bg-black text-white">
      ...
      <main className="relative z-10 px-5 pb-16 sm:px-6 md:min-h-[calc(100svh-56px)]">
        <div className="mx-auto grid w-full max-w-[1280px] items-center gap-10 py-10 md:min-h-[calc(100svh-56px)] md:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)] md:gap-8 md:py-0">
